    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="mr-auto font-bold text-base font-lg text-primary">
                    Data Produk
                </h2>
            </div>
            <form action="{{ route($route, ['id' => $id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button id="simpanButton" class="mt-5 btn btn-primary"
                        onClick="this.form.submit(); this.disabled=true; this.value='Sending…'; "> Simpan </button>
...
<script>
    $(document).ready(function() {
        $('#input-satuan-terkecil{{ $id }}').on('change', function() {
            ...
            var selectedText = $(this).find('option[value="' + selectedValue + '"]').text();
