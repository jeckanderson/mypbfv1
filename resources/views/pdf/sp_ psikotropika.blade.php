...
<body>
    <div class="container">
        ...
        <div class="title">
            <h4>SURAT PESANAN OBAT MENGANDUNG PSIKOTROPIKA</h4>
        </div>
        <div class="sub-title">
        ...
        <div class="invoice-details">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    <td colspan="2">Mengajukan pesanan obat mengandung Psikotropika kepada:</td>
                </tr>
                <tr>
        ...
        <div class="invoice-hal">
            <p>Jenis Obat mengandung Psikotropika yang dipesan adalah :</p>
        </div>
        <table class="table">
            <thead>
                <tr>
        ...
        <br>
        <div class="invoice-details">
            <p>Obat yang mengandung Psikotropika tersebut akan digunakan untuk memenuhi kebutuhan:</p>
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    <td style="width: 20%;">Nama PBF</td>
