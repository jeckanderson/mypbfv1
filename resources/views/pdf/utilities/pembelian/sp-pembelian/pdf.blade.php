...
<body>
    @if ($detail !== null && count($detail) > 0)
        ...
        <h1 style="text-align: center;">Lap. SP. Pembelian</h1>
            ...
            <table class="analisisorder">
                ...
                <tbody>
                    ...
                    <tr class="text-center intro-x">
                        ...
                        <td class="border border-slate-600">{{ $details->tgl_sp }}</td>
                        <td class="border border-slate-600">{{ $details->suplier->nama_suplier }}</td>
                        <td class="border border-slate-600">{{ $details->no_sp }}</td>
                        <td class="border border-slate-600">{{ $details->tipe_sp }}</td>
