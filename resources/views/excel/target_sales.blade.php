...
<thead>
  ...
  <tr>
    <th colspan="6" align="center">TARGET SALES</th>
  </tr>
  @if($target)
  <tr>
      <td colspan="6">Nama Sales: {{ $target->sales }}</td>
  </tr>
  <tr>
    <td colspan="6">Nama SPV: {{ $target->supervisor }}</td>
  </tr>
  <tr>
    <td colspan="6">Rayon: {{ $target->area_rayon }}</td>
  </tr>
  <tr>
    <td colspan="6">Tahun: {{ $target->tahun }}</td>
  </tr>
  @endif
</thead>
