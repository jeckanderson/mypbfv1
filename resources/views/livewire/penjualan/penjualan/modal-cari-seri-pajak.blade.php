<div class="modal-content">
        ...
        <div class="overflow-auto">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td class="font-bold text-center text-pending border border-slate-600" colspan="3">Belum
                                ada nomor
    ...
    <div class="modal-footer">
        <button class="btn btn-primary" wire:click='pilihPajak' data-tw-dismiss="modal">Pilih</button>
