        ...
        <div class="col-span-6 md:col-span-3">
            ...
            <div class="col-span-6 md:col-span-3"style="position: absolute; top: 285px; right:55px;">
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('cetak_pdf_rekap_hutang', [
                        'search' => $search,
        ...
        <table class="table mt-5">
            <thead class="text-center">
                <tr>
                    ...
                    <th rowspan="2" class="border border-slate-600">Nama Supplier</th>
                    <th rowspan="2" class="border border-slate-600">Jumlah Hutang</th>
            ...
            <tbody>
                @forelse ($hutang as $hutangs)
                    <tr class="text-center intro-x">
                        ...
                        <td class="border border-slate-600">{{ $hutangs->suplier->kode }}</td>

                        <td class="border border-slate-600">
                            {{ $hutangs->suplier->nama_suplier }}</td>
                        <td class="border border-slate-600">{{ $hutangs->total_hutang }}</td>
                        <td class="border border-slate-600">{{ $hutangs->sumber }}</td>
