...
class SubRakController extends Controller
{
    ...
    {
        $this->middleware(['permission:akses_sub_rak']);
        $this->middleware(['permission:tambah_sub_rak'])->only('tambahSubRak');
        $this->middleware(['permission:aksi_sub_rak'])->only('editSubRak');
        $this->middleware(['permission:aksi_sub_rak'])->only('deleteSubRak');
    }
