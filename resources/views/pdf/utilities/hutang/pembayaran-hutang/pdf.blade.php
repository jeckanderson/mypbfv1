...
<body>
    @if ($detail !== null && count($detail) > 0)
        <h1 style="text-align: center;">Lap. Pembayaran Hutang </h1>
            ...
            <tbody>
                @foreach ($detail as $hutangs)
                    <tr class="text-center intro-x">
                        ...
                        <td class="border border-slate-600">{{ $hutangs->pembelian->tgl_input }}</td>
                        <td class="border border-slate-600">{{ $hutangs->bayar->no_reff }}</td>
                        <td class="border border-slate-600">{{ $hutangs->bayar->akun->jenis_akun }}</td>
