...
class SetUserController extends Controller
{
    ...
    {
        $this->middleware(['permission:akses_user']);
        $this->middleware(['permission:tambah_user'])->only('tambahSetUser');
        $this->middleware(['permission:aksi_user'])->only('editSetUser');
        $this->middleware(['permission:aksi_user'])->only('deleteSetUser');
    }
