<div class="modal-content">
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th class="border border-p-600">Suplier</th>
                ...
                <tbody>
                    @forelse ($pembelians as $pembelian)
                        <tr>
                            <td class="border border-slate-600">{{ $pembelian->tgl_faktur }}</td>
                            ...
                            <td class="border border-slate-600">
                                <input data-tw-merge type="radio" wire:model='selectedPembelian'
                                    ...
                                    id="checkbox-switch-1-{{ $pembelian->id }}" value="{{ $pembelian->id }}" />
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td class="font-bold text-pending text-center" colspan="5">Belum ada data pembelian
                                tersedia</td>
                        </tr>
                    @endforelse
                </tbody>
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-primary" data-tw-dismiss="modal" wire:click='pilihPembelian'>Pilih</button>
    </div>
</div>
