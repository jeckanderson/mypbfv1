...
class ProdusenController extends Controller
{
    ...
    {
        $this->middleware(['permission:akses_produsen']);
        $this->middleware(['permission:tambah_produsen'])->only('tambahProdusen');
        $this->middleware(['permission:aksi_produsen'])->only('editProdusen');
        $this->middleware(['permission:aksi_produsen'])->only('deleteProdusen');
    }
