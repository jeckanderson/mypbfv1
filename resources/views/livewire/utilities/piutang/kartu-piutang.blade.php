        ...
        <div class="col-span-6 md:col-span-3">
            ...
            <div class="flex justify-between">
                ...
                <div
                    ...
                    Total Piutang : {{ number_format($total, 0, ',', '.') }}
                </div>
            </div>


            <div class="flex items-center w-1/4 mb-2 gap-2" wire:ignore>
                {{-- <label data-tw-merge for="pelanggan" class="inline-block mt-2 mb-2 sm:w-20">
                    Pelanggan
                </label> --}}
                <select data-tw-merge id="pelanggan" aria-label="Default select example" wire:model.live="pelangganId"
                    class="form-control tom-select">
                    <option value="w-56">Pelanggan</option>
                ...
                <div class="col-span-5 md:col-span-2">
                    <div class="w-full flex gap-2 justify-end ">
                        <button class="text-white font-weight btn btn-success" wire:click="exportExcel">
                            <div class="flex gap-1" wire:ignore>
                                <i data-feather="file-text" class="w-4 h-4 mr-1"></i>Excel
                            </div>
                        </button>
                        {{-- <button class="font-weight btn btn-outline-primary btn-sm" wire:click="exportPdf">
            <span wire:ignore><i data-feather="printer" class="w-5 h-5 mr-1"></i>PDF</span></button> --}}
                        <a href="{{ route('print_kartu_piutang', [
                            'search' => $search,
            ...
            {{-- <div class="relative w-56 mb-3 text-slate-500">
                <div class="relative w-56 text-slate-500 ">
                    <input type="text" id="search" name="search" wire:model.live.debounce.300ms="search"
                        class="w-56 pr-10 form-control box" placeholder="Cari No. Faktur">
                    ...
                    <div class="mt-2 intro-y box">
                        <div
                            ...
                            <h2 class="flex w-1/2 gap-3 my-1 font-bold text-white text-md">
                                ...
                                <label for="w-60">Total Piutang :</label>
                                    ...
                                    <table class="table mt-2 table-auto bg-slate-600">
                                        ...
                                        <thead>
                                            ...
                                            <tr class="header-gray">
                                                ...
                                                <th class="border border-slate-600">Piutang Final</th>
