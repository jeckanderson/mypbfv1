...
<body>
    ...
    <h1 style="text-align: center;">Lap. Detail SP. Penjualan</h1>
    ...
    <div class="margin-top">
        <table class="w-full">
            <tr>
                ...
                <td class="w-half">
                    {{-- <div>{{$sppenjualans->spPenjualan->tgl_input}}</div> --}}
                    <div>{{$sppenjualans->spPenjualan->no_reff}}</div>
    ...
    <table class="analisisorder">
        ...
        <tbody>
                ...
                <tr class="text-center intro-x">
                    ...
                    <td class="border border-slate-600">{{ $sppenjualans->satuanProduk->satuan }}
                    </td>
                    <td class="border border-slate-600">
                        {{ $sppenjualans->spPenjualan->keterangan }}
                    </td>
                </tr>
            @endforeach
        </tbody>
