...
class GudangController extends Controller
{
    ...
    {
        $this->middleware(['permission:akses_nama_gudang']);
        $this->middleware(['permission:tambah_nama_gudang'])->only('tambahGudang');
        $this->middleware(['permission:aksi_nama_gudang'])->only('editGudang');
        $this->middleware(['permission:aksi_nama_gudang'])->only('deleteGudang');
    }
