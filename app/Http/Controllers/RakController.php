...
class RakController extends Controller
{
    ...
    {
        $this->middleware(['permission:akses_rak']);
        $this->middleware(['permission:tambah_rak'])->only('tambahRak');
        $this->middleware(['permission:aksi_rak'])->only('editRak');
        $this->middleware(['permission:aksi_rak'])->only('deleteRak');
    }
